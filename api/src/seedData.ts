...
export const reviews: Review[] = [
    {
        ...
        rating: 5,
        title: "My cat now runs the kitchen",
        body: "The SmartFeeder One learned my cat's nap schedule in two days. Now she gets fed exactly when she wakes up from her 47th nap. 10/10 would automate again.",
    ...
    },
    {
        reviewId: 2,
        productId: 1,
        author: "PurrfectParent42",
        rating: 4,
        title: "Great but the AI is too smart",
        body: "My cat figured out if she fake-naps she gets extra treats. The feeder caught on after a week. Now they're in a cold war. Still a great product though.",
    ...
    },
    {
        reviewId: 3,
        productId: 4,
        author: "TailTracker99",
        rating: 5,
        title: "Zoomie alerts are life-changing",
        body: "Got a push notification at 3am: 'ZOOMIE EVENT DETECTED - MAGNITUDE 8.7'. Worth every penny just for that. GPS tracking is also incredibly accurate.",
    ...
    },
    {
        reviewId: 4,
        productId: 3,
        author: "FelineCinephile",
        rating: 4,
        title: "My cat's Netflix addiction is real",
        body: "CatFlix knows my cat prefers birds over squirrels and has started curating her feed accordingly. She now judges me for watching human TV.",
        createdAt: "2025-11-28T18:45:00Z",
        helpful: 6
    },
    {
        reviewId: 5,
        ...
        rating: 5,
        title: "Facial recognition actually works",
        body: "I have three cats and this fountain knows each one. Mittens gets the gentle flow, Thor gets the waterfall, and Gizmo gets notifications to drink more. Future is meow.",
